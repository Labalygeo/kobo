...
-   d'une **application de collecte** de données : [**KoboCollect**](https://play.google.com/store/apps/details?id=org.koboc.collect.android&hl=fr&gl=US) (ou [Enketo](https://enketo.org/) et [GIC Collect](https://apps.apple.com/kh/app/gic-collect/id1485932698?l=fr) pour Apple)
...
```{=html}
<iframe width="990" height="580" src="https://www.warwi.org/organisations/" title="Warwi"></iframe>
```
...
Pour utiliser KoBotoolBox, commencez par **créer un compte : [http://www.KoBotoolBox.org](http://www.KoBotoolBox.org)**
...
**De nombreux [types de question](https://support.KoBotoolBox.org/question_types.html) disponibles :**
...
## 5. Deploiement du formulaire (page web)
...
## 6. Deploiement sur smartphone

Possibiliter de télécharger le questionnaire dans l'application koboCollect, Enketo ou GIC collect.

![](images/smartphone2.png)
...
- Pas adapté à tout type d'enquête   
...
- [https://support.kobotoolbox.org/](https://support.kobotoolbox.org/)    
- [https://community.kobotoolbox.org/](https://community.kobotoolbox.org/)   
...
::: {.column width="50%"}
![](images/logo_PRODIG.png)
:::

::: {.column width="50%"}

![](images/USSEIN-LOGO-entete-site.png){width=60%}
:::

::: {.column width="50%"}

![](images/cnrs.png){width=30%}


Hugues Pecout, Ingénieur d’études en sciences de l’information géographique (CNRS, Géographie-Cités)
