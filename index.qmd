...
-   d'une **application de collecte** de données : [**KoboCollect**](https://play.google.com/store/apps/details?id=org.koboc.collect.android&hl=fr&gl=US){target="_blank"} (ou [Enketo](https://enketo.org/){target="_blank"} et [GIC Collect](https://apps.apple.com/kh/app/gic-collect/id1485932698?l=fr){target="_blank"} pour Apple)
...
::: {.center}
Voir un [exemple de formulaire complet](https://enke.to/x/widgets){target="_blank"}
:::
...
- Pas adapté à tout les types d'enquête (ex : longitudinale)   
...
:::
::: {.column width="40%"}
![](images/logo_PRODIG.png){width=100%}
:::
::: {.column width="5%"}
:::
::: {.column width="30%"}
